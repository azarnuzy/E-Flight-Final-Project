      ...
      <div className="text-center items-center text-white bg-primary p-5">
        <div className='grid lg:grid-cols-3 grid-cols-1 mt-10'>
          <div className='lg:ml-[60px] mx-auto'>
            ...
            <p className='text-white text-justify text-sm lg:w-[350px] w-[300px]'>Flyket is an electronic plane ticket purchasing website that makes it easier and more effective</p>
          </div>
