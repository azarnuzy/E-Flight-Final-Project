                ...
                <div className='px-4'>
                    ...
                    <div className='mb-4'>
                        <div>
                            ...
                            <input className='mt-1 px-3 py-1 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:primary focus:primary block  rounded-md sm:text-sm focus:ring-1" placeholder="you@example.com"' />
                        </div>
                        <div className='my-2'>
