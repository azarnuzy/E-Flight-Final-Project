            ...
            <div className='bg-grey-600 h-screen md:w-1/4 md:h-full pt-5 border-2 rounded-md '>
                ...
                <div className='border-b-2 border-grey-800 pl-4 py-3 md:py-5'>
                    <div className='py-3 md:py-3  flex items-center gap-3'>
                        <BsFillPersonFill className='text-primary' /> <Link className='text-sm hover:text-secondary'>  Account </Link>
                    </div>
                    <div className='py-3 md:py-3 flex items-center gap-3'>
                        <BsCardList className='text-primary' /> <Link className='text-sm hover:text-secondary'>  My Orders </Link>
                    </div>
