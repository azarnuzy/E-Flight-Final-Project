	...
	return (
		<>
			<div className='md:max-w-[1024px] mx-auto mt-10 mb-6'>
				<h1 className='text-xl font-medium mb-3'>Recent Orders</h1>
				<div className='border-2 rounded-md'>
					<div className='md:flex md:justify-between border-b-2 px-2 p-2'>
						...
						<div className='pr-2'>
							<Link className='text-base text-primary md:flex md:items-center gap-2'>Full Details <AiOutlineRight className='text-xs text-primary' /> </Link>
						</div>
					</div>
					...
					<div className='md:flex '>
						...
						<div className='md:flex p-3 border-r-2'>
							<img
								...
								alt='img-plane' />
							<div className='ml-4 md:flex md:flex-col justify-center'>
						...
						<div className=" border-r-2 ">
							<div className='md:flex justify-center gap-3 p-3'>
								...
								<div className="flex flex-col  text-center w-1/2 mx-4">
						...
						{/* right */}
						<div className='md:flex items-center p-2 gap-5' >
